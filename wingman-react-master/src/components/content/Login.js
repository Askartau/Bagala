                        ...
                        <div className="col-12 col-md-8 col-lg-7">
                            <div className="card card-lg text-center">
                                <div className="card-body">
                                    <div className="mb-5">
                                        <h1 className="h2 mb-2">Hello again</h1>
                                    ...
                                    <div className="row no-gutters justify-content-center">
                                        <form className="text-left col-lg-8">
                                            ...
                                            <div className="form-group">
                                                ...
                                                <small>Forgot password? <Button href="#" variant="link">Reset here</Button>
                                                </small>
                                            </div>
                                            <div>
                            ...
                            <div className="text-center">
                                <span className="text-small">Don't have an account yet? <Button href="#" variant= "link">Create one</Button>
                                </span>
                            </div>
                        </div>
                    </div>
